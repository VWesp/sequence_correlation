...
for domain in "Archaea" "Bacteria" "Eukaryota" "Viruses"; do
	...
	/root/anaconda3/bin/python3 CombineAAStats.py -d /home/vwesp/uniprot_knowledgebase/$domain/aa_distributions/ -o /home/vwesp/uniprot_knowledgebase/$domain/combined_distributions.csv -e /home/vwesp/uniprot_knowledgebase/$domain/encoding_data.csv -c genetic_codes/ -m code_map.csv -r 100000 -ch 1000 -t 20
	echo ""
done
