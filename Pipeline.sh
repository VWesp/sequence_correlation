...
for domain in "Archaea"; do
	echo $domain
	/home/we63kel/anaconda3/bin/python3 DownloadProteome.py -d $domain -o /home/we63kel/uniprot_knowledgebase/$domain/data -t 5 -w 15 &&
	...
	/home/we63kel/anaconda3/bin/python3 CombineAAStats.py -d /home/we63kel/uniprot_knowledgebase/$domain/aa_distributions/ -o /home/we63kel/uniprot_knowledgebase/$domain/combined_distributions.csv -e /home/we63kel/uniprot_knowledgebase/$domain/encoding_data.csv -c genetic_codes/ -m code_map.csv -r 100000 -ch 1000 -t 60
	echo ""
done
