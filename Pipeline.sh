...
for domain in "Archaea" "Bacteria" "Eukaryota" "Viruses"; do
	...
	/root/anaconda3/bin/python3 CombineAAStats.py -d /home/vwesp/uniprot_knowledgebase/$domain/aa_distributions/ -o /home/vwesp/uniprot_knowledgebase/$domain/output/ -e /home/vwesp/uniprot_knowledgebase/$domain/encoding_data.csv -c genetic_codes/ -m code_map.csv -a 1e-12 -r 10000 -ch 1000 -t 22
	echo ""
done
